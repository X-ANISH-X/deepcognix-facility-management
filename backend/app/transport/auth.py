...
from app.model.auth_model import CurrentUserResponse, RefreshTokenRequest, Token, UserLogin, UserRegister
...
def refresh_access_token(payload: RefreshTokenRequest, db=Depends(get_db_connection)):
